...
@Component({
  ...
  styles: [`
    ...
    .btn-icon{background:none;border:none;cursor:pointer;font-size:1rem;padding:.2rem}
    ...
    .modal-card{background:#fff;border-radius:10px;padding:2rem;width:90%;max-width:550px;max-height:90vh;overflow-y:auto}
