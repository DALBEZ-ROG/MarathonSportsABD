...
export class NavbarComponent {
  ...
  private allItems: NavItem[] = [
    ...
    { label: 'Devoluciones', route: '/devoluciones', icon: '<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><polyline points="1 4 1 10 7 10"/><path d="M3.51 15a9 9 0 102.13-9.36L1 10"/></svg>' },
